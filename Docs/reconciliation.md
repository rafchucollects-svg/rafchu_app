...
4. Review one remaining payment at a time. Choose a recommended card deal or search for another. Selecting one correctable sale proposes the statement amount and shows the original value and proposed adjustment. **Save and next** finalizes it, records the audit, and advances. Validation and save errors appear beside that button without losing the selection. **Save progress** retains an unfinished draft; **Review later** moves to another payment without clearing it.
