window.addEventListener('message', async event => {
  ...
  if (typeof requestId !== 'string' || requestId.length > 100 || !['status', 'report', 'start', 'cancel', 'suggest', 'products', 'resume', 'resume-suggestions', 'open-reader'].includes(action)) return;
  let result;
